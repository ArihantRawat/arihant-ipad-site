...
export default function ArihantGPTApp(_props: Props) {
        ...
        {messages.length === 0 && (
          ...
          >
            <div style={{ width: 60, height: 60, borderRadius: 30, overflow: "hidden", marginBottom: 14, position: "relative" }}>
              <Image src={profile.photo} alt="Arihant" fill style={{ objectFit: "cover" }} />
            </div>
            <h2 style={{ fontSize: 19, fontWeight: 600, color: "#1c1c1e", marginBottom: 6, fontFamily: "-apple-system, sans-serif" }}>
              What do you want to know about Arihant?
            </h2>
      ...
      >
        <div style={{
          ...
          <input
            ...
            placeholder="Message ArihantGPT..."
            disabled={loading}
            style={{
