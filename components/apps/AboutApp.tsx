    ...
    <div className="app-window" style={{ background: "#f2f2f7" }}>
      ...
      >
        ...
        <motion.div {...fadeUp(0.14)} style={{ marginBottom: 24 }}>
          ...
          >
            {[
              ...
              >
                <span style={{ color: "#a855f7", fontSize: 14, marginTop: 1 }}>
                  {"\u2192"}
                </span>
        ...
        <motion.div {...fadeUp(0.18)}>
          ...
          >
            {[
              { label: "GitHub", value: "ArihantRawat", url: social.github, color: "#24292e" },
              { label: "LinkedIn", value: "arihantrawat", url: social.linkedin, color: "#0a66c2" },
              { label: "YouTube", value: "@ArihantRawat", url: social.youtube, color: "#ff0000" },
              { label: "Letterboxd", value: "arihantrawat", url: social.letterboxd, color: "#ff8000" },
              { label: "RateYourMusic", value: "@arihantrawat", url: social.rateyourmusic, color: "#ed1c24" },
              { label: "X", value: "@arihantrawat", url: social.x, color: "#000000" },
            ].filter((link) => Boolean(link.url && link.url.trim())).map((link, i, arr) => (
              <a
                key={link.label}
                href={link.url}
                target="_blank"
