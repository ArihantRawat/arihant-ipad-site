...
export default function IPadPage() {
  ...
  const [, setUserScale] = useState<number | null>(null);
  ...
  const ArihantsPortraitStyle: CSSProperties = {
    background: "linear-gradient(175deg, #ffffff 0%, #e6d8ff 50%, #b794f4 100%)",
    backgroundClip: "text",
  ...
  const iPadPortraitStyle: CSSProperties = {
    background: "linear-gradient(5deg, #ffffff 0%, #e2ccff 55%, #9f7aea 100%)",
    backgroundClip: "text",
    WebkitBackgroundClip: "text",
    color: "transparent",
    fontSize: "6rem",
    ...
    return (
      <div
        style={{
          ...
          display: "grid",
          placeItems: "center",
          background: "linear-gradient(160deg, #110a1f 0%, #1a1030 35%, #140c26 65%, #0c0718 100%)",
        ...
        {!isPortrait && (
          ...
          >
            <div
              ...
              aria-hidden="true"
              style={{
                background: "linear-gradient(160deg, #f5ebff 0%, #c084fc 45%, #7c3aed 100%)",
                WebkitBackgroundClip: "text",
                backgroundClip: "text",
                color: "transparent",
              }}
            ...
            <div
              ...
              aria-hidden="true"
              style={{
                background: "linear-gradient(20deg, #ffffff 0%, #e2ccff 50%, #9f7aea 100%)",
                WebkitBackgroundClip: "text",
                backgroundClip: "text",
                color: "transparent",
              }}
